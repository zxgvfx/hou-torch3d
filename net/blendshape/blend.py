...
from pyLib.houLib.tools import meshes_attr_interpolate as maint

class BlendMeshNet(nn.Module):
    def __init__(self,temp_mesh: Meshes):
        super(BlendMeshNet, self).__init__()
        self.temp_mesh = temp_mesh
        self.temp_points = hou.Geometry
        self.trg_points = hou.Geometry
    ...
    def forward(self,x: Meshes):
        ...
        if not self.temp_points:
            ...
            temp_points,trg_points,new_src_mesh_id,_ = maint.sample_points_from_geo(self.temp_points,
                                                           self.temp_mesh,
                                                           self.trg_points)
    ...
    def set_landmark(self,temp_points: hou.Geometry,
